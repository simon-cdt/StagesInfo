...
export default function DeleteCompanyAdmin({
  id,
  refetch,
}: {
  id: string;
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            Êtes-vous vraiment sûr de supprimer l&apos;entreprise ?
          </AlertDialogTitle>
          <AlertDialogDescription>
            Cette action est irréversible, l&apos;entreprise devra se refaire un
            compte.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
