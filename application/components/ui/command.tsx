...
function CommandInput({
  ...
  return (
    <div
      className="border-input flex items-center gap-2 border-b px-5"
      cmdk-input-wrapper=""
    >
      <Icon src="search" className="text-muted-foreground/80 me-3 w-4" />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "pointer data-[selected=true]:bg-accent data-[selected=true]:text-accent-foreground relative flex cursor-default items-center gap-3 rounded-md px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
      {...props}
    />
