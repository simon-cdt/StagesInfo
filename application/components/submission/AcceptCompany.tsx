...
import { acceptSubmission } from "@/lib/actions/submission";

export default function AcceptCompany({
  id,
  refetch,
}: {
  id: string;
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Cette action ne peut pas être annulée. Toutes les autres
            candidatures seront refusées.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
