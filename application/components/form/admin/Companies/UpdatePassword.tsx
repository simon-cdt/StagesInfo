...
import { updateCompanyPasswordAdmin } from "@/lib/actions/admin/company";

export default function UpdateCompanyPasswordAdminForm({ id }: { id: string }) {
  ...
  const handleSubmitForm = async (data: FormSchema) => {
    const response = await updateCompanyPasswordAdmin({
      id,
